...
これは「シャープの強い帰無仮説」と呼ばれるのは、ゼロ平均効果の帰無仮説よりも制約が厳しいためである。たとえば、観測の半数がの処置効果を持ち、残りの半数が ￼ の処置効果を持つ場合、ゼロ平均効果の帰無仮説は成立するが、フィッシャーのシャープ・ヌルの帰無仮説は成立しない。
